...
- model/revision/tokenizer/tokenizer-revision mismatch between vLLM launch and generator spec, served-name/request-model mismatch, duplicate positional/`--model` or repeated identity options, and synthetic model/tokenizer binding used for actual authorization;
