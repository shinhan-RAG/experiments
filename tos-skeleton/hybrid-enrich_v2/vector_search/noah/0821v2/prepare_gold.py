#!/usr/bin/env python3
"""Build and report the audited v5 train/test denominator."""
...
ROOT = HERE.parents[2]
V5_DIR = HERE / "out" / "gold_v5"
DEFAULT_90 = V5_DIR / "gold_v5_test_full.jsonl"
DEFAULT_TRAIN = V5_DIR / "gold_v5_train_full.jsonl"
...
def main():
    ...
    manifest = {
        "version": "v5",
        "default_train337": count_gold(DEFAULT_TRAIN),
        "default_test90": count_gold(DEFAULT_90),
        "raw_test149": {"path": str(RAW_149.resolve()), "sha256": digest(RAW_149)},
    }
    if args.spanmap:
