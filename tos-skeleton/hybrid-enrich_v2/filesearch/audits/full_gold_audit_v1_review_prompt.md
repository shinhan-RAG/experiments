...
1. `filesearch/audits/full_gold_audit_v1_batch01_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `filesearch/out/gold_train_scoped_u3_reviewed_overlay_v1.jsonl`
4. `filesearch/out/elements_u3jo.jsonl`
5. `filesearch/audits/full_gold_audit_v1_batch01_luna.json`
...
Luna 제안을 정답으로 가정하지 말고, 배치 qid 5개를 공식 질문·답·출처와 원문 JO만으로
독립 재감사하라. 특히 다음을 반증 검사한다.
