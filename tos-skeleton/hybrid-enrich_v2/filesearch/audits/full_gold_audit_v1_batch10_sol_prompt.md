...
1. `filesearch/audits/full_gold_audit_v1_batch10_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `filesearch/out/gold_train_scoped_u3_reviewed_overlay_v12.jsonl`
4. `filesearch/out/elements_u3jo.jsonl`
5. `filesearch/audits/full_gold_audit_v1_batch10_luna.json`

주의: 첫 감사의 적용 검증 오류가 있다: duplicate v3-offline-0444 and missing v3-offline-0440; primary audit is structurally invalid. 해당 판정을 복사하지 말고 현재 group/member와 원문을 다시 확인하라.
