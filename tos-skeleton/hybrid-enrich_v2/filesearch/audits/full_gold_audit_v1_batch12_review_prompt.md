...
1. `audits/full_gold_audit_v1_batch12_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `out/gold_train_scoped_u3_reviewed_overlay_v14.jsonl`
4. `out/elements_u3jo.jsonl`
5. `audits/full_gold_audit_v1_batch12_primary_claude.json`
