...
1. `filesearch/audits/full_gold_audit_v1_batch09_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `filesearch/out/gold_train_scoped_u3_reviewed_overlay_v11.jsonl`
4. `filesearch/out/elements_u3jo.jsonl`
5. `filesearch/audits/full_gold_audit_v1_batch09_luna.json`

주의: 첫 감사의 적용 검증 오류가 있다: primary duplicated v3-offline-0446 and v3-generated-def-0032, producing 12 decisions for 10 qids. 해당 판정을 복사하지 말고 현재 group/member와 원문을 다시 확인하라.
...
배치 qid 10개를 입력 배열 순서대로 정확히 모두 감사하라. 첫 감사 결과는 반박 가능한 참고 자료일 뿐이며, 각 qid마다 다음을 확인한다.
