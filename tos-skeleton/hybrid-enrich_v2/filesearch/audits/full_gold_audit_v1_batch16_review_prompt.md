...
1. `audits/full_gold_audit_v1_batch16_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `out/gold_train_scoped_u3_reviewed_overlay_v18.jsonl`
4. `out/elements_u3jo.jsonl`
5. `audits/full_gold_audit_v1_batch16_primary_claude.json`
...
배치 qid 23개를 입력 배열 순서대로 정확히 모두 감사하라. 첫 감사 결과는 반박 가능한 참고 자료일 뿐이며, 각 qid마다 다음을 확인한다.
