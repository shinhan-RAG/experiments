...
1. `filesearch/audits/full_gold_audit_v1_batch04_qids.json`
2. `/Users/ralph/Desktop/신한라이프/data_set/noah_qaset/정답셋_348_train_v3_retrieval_250212.csv`
3. `filesearch/out/gold_train_scoped_u3_reviewed_overlay_v5.jsonl`
4. `filesearch/out/elements_u3jo.jsonl`
5. `filesearch/audits/full_gold_audit_v1_batch04_luna.json`

주의: 첫 감사의 적용 검증 오류가 있다: duplicate qids 0404/0500/0415 and missing qid 0107; output must contain exactly the frozen 20 qids once in order. 해당 판정을 복사하지 말고 현재 group/member와 원문을 다시 확인하라.
...
배치 qid 20개를 입력 배열 순서대로 정확히 모두 감사하라. 첫 감사 결과는 반박 가능한 참고 자료일 뿐이며, 각 qid마다 다음을 확인한다.
